...
class UnitOfMeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unit_of_measure" do
    assert_difference('UnitOfMeasure.count') do
      post unit_of_measures_url, params: { unit_of_measure: { name: @unit_of_measure.name, shipment_category_id: @unit_of_measure.shipment_category_id } }
    end
  ...
  test "should update unit_of_measure" do
    patch unit_of_measure_url(@unit_of_measure), params: { unit_of_measure: { name: @unit_of_measure.name, shipment_category_id: @unit_of_measure.shipment_category_id } }
